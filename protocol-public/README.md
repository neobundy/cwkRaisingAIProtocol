...
- **CRITICAL-INSIGHTS.md**: Fundamental insights about LLM limitations, especially regarding the "illusion of continuity" between interactions. Essential reading for understanding why the protocol is designed as it is.
...
- **INSTRUCTION_SETS.md**: Comprehensive documentation of all commands supported by the protocol, including file references and implementation details.
